...
/*
 * A classe Notificador é um objeto feito para correr em paralelo (Thread) o qual procura uma pasta
 * por atualizações e as encaminha para uma lista de espera global para a inserção no banco de
 * dados.
 * A lista de espera é uma ArrayList de ArrayLists com as informações de cada atualização.
 */
public class Notificador {
	public static ArrayList listaDeEspera = new ArrayList();
	public int num_estacao = 1;
